          ...
          <div class="row">
            <a href="#!">
              <div style="padding: 30px;" class="grey lighten-3 col s5 waves-effect">
                ...
                <span class="indigo-text text-lighten-1"><h5>Admin</h5></span>
              </div>
            </a>
          ...
          <div class="row">
            <a href="{{ route('admin.create')}}">
              <div style="padding: 30px;" class="grey lighten-3 col s5 waves-effect">
                ...
                <span class="indigo-text text-lighten-1"><h5>Rooms</h5></span>
              </div>
            </a>
            ...
            <a href="#!">
              <div style="padding: 30px;" class="grey lighten-3 col s5 waves-effect">
                ...
                <span class="indigo-text text-lighten-1"><h5>Room Type</h5></span>
              </div>
            </a>
          </div>
        </div>
