...
<ul id="slide-out" class="side-nav fixed z-depth-2">
    ...
    <ul class="collapsible" data-collapsible="accordion">
      <li id="dash_users">
        <div id="dash_users_header" class="collapsible-header waves-effect"><b>Account</b></div>
        <div id="dash_users_body" class="collapsible-body">
          <ul>
            ...
            <li id="users_customer">
              <a class="waves-effect" style="text-decoration: none;" href="#!">User</a>
            </li>
          </ul>
        </div>
      </li>
        ...
        <div id="dash_products_body" class="collapsible-body">
          <ul>
            <li id="products_product">
              <a class="waves-effect" style="text-decoration: none;" href="#!">Rooms</a>
              <a class="waves-effect" style="text-decoration: none;" href="#!">Room Type</a>
            </li>
          </ul>
        </div>
      </li>
